...
فرمت: \`سال/ماه/روز\` (مثال: \`/teleport 1404/02/10\`)`,
  ...
  // AI Flow Messages
  SCHEDULE_AI_PROMPT: `✨ *افزودن برنامه با هوش مصنوعی*

لطفاً متن کامل برنامه هفتگی خود را که از سامانه دانشگاه کپی کرده‌اید، در اینجا الصاق کنید. من آن را تحلیل کرده و به صورت خودکار برایتان ثبت می‌کنم.

👇 منتظر پیامتان هستم...`,

  AI_THINKING: "🤔 در حال دریافت و بررسی اطلاعات... لطفاً چند لحظه صبر کنید.",

  AI_PROCESSING: "🤖 دریافت شد! در حال پردازش و تحلیل برنامه شما با هوش مصنوعی...",

  AI_ERROR: "⚠️ متاسفانه هوش مصنوعی نتوانست برنامه شما را تحلیل کند. لطفاً مطمئن شوید متنی که ارسال می‌کنید کامل و صحیح است و دوباره تلاش کنید.",

  AI_RETRY: "⚠️ در ارتباط با سرویس هوش مصنوعی مشکلی پیش آمد. در حال تلاش مجدد...",

  AI_PREVIEW_HEADER: `✅ *پیش‌نمایش برنامه شما*

هوش مصنوعی برنامه شما را به صورت زیر تحلیل کرده است. لطفاً آن را به دقت بررسی کنید. اگر همه چیز درست است، دکمه "تایید و ذخیره" را بزنید.`
};
